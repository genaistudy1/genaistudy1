...
Yes, you can stop participating at any time without penalty. If you choose to withdraw, simply close the browser window and return the study on Prolific. Your answers will not be saved if you exit the study early. However, please note that you will not receive payment in this case. 
